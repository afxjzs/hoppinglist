...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    hoppingListAuthUserSubject.add(
      HoppingListAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<HoppingListAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  HoppingListAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = HoppingListAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    hoppingListAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
HoppingListAuthUser? currentUser;
