  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ItemsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ItemsRow> editItemItemsRowList = snapshot.data!;

        final editItemItemsRow =
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  StreamBuilder<List<LocationsRow>>(
                                    stream:
                                        _model.checkboxGroupSupabaseStream ??=
                                            SupaFlow.client
                                                .from("locations")
                          ...
                          onPressed: () async {
                            if (_model.checkboxGroupValues!.length > 0) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    '${_model.itemNameTextController.text} updated!',
                                    style: FlutterFlowTheme.of(context)
                                        .headlineMedium
                                        .override(
                                          fontFamily: 'Plus Jakarta Sans',
